...
const LoginPage = () => {
  ...
  // Function to test the encryption service
  // const testEncryption = () => {
  //   const encService = new EncryptionService();
  //   const testData = { user_id: "123456", password: "Test@123" };

  //   const encrypted = encService.encrypt(testData);
  //   console.log("Encrypted:", encrypted);

  //   // For verification only
  //   const decrypted = encService.decrypt(encrypted);
  //   console.log("Decrypted:", decrypted);
  //   console.log("Parsed:", decrypted); // Already parsed
  // };
        ...
        <div className="login-right mr-4 p-5">
          ...
          <form className="login-form" onSubmit={loginFormik.handleSubmit}>
            ...
            <button
              ...
              onClick={testEncryption} // Trigger the test function
            >
              Test
            </button>
          </form>
